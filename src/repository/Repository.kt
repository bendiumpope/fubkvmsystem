package com.fubk_visitor_system.repository

import com.fubk_visitor_system.model.*
import com.fubk_visitor_system.webapp.Schedules
...
interface Repository {
    ...
    suspend fun updateuser(userId: String, newSurName: String, newFirstName: String,
    ...
    //VISITINGSCHEDULE
    suspend fun addvisitingschedule(userId: String, office: String, date:String, duration:String, datebooked:String): VisitingSchedule?
