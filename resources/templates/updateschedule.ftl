    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                <form action="/updateschedule" method="post" class="sign-in-form">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="office" placeholder="enter your Office Name" value="${schedule.office}" required>
                    </div>

                    <div class="input-field">
                        <i class="fas fa-calendar"></i>
                        <input type="date" name="date" placeholder="Date" value="${schedule.date}" required>
                    </div>
                    <div class="input-field">
                        <i class="fas fa-clock"></i>
                        <input type="text"  name="timeduration" placeholder="enter available time (12:00 AM - 05:00PM)" value="${schedule.timeduration}" required>
                    </div>
                    <div class="input-field">
                        <i class="fas fa-clock"></i>
                        <input type="text"  name="datebooked" placeholder="datebooked" value="${schedule.datebooked}" required>
                    </div>
